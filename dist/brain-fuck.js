...
exports.MEM_SIZE = exports.EXTEND_SIZE = exports.MAX_CHAR_VALUE = void 0;
...
function jumpForward(program, _iptr) {
  var iptr = _iptr,
      openBracketsCount = 1;
...
function jumpBackward(program, _iptr) {
  var iptr = _iptr,
...
},{}],"brain-fuck.js":[function(require,module,exports) {
"use strict";
        ...
        switch (this.program[this.iptr]) {
          ...
          case '[':
            if (!this.memory[this.mptr]) {
              this.iptr = (0, _jump.jumpForward)(this.program, this.iptr);
            }
          ...
          case ']':
            if (this.memory[this.mptr]) {
              this.iptr = (0, _jump.jumpBackward)(this.program, this.iptr);
            }
...
},{"./constants/index":"constants/index.js","./utils/jump":"utils/jump.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
